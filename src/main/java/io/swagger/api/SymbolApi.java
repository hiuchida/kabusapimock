...
public interface SymbolApi {
    ...
    @Operation(summary = "銘柄情報", description = "指定した銘柄情報を取得します", tags={ "info" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "OK", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SymbolSuccess.class))),
