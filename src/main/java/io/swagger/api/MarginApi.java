...
public interface MarginApi {
    ...
    @Operation(summary = "プレミアム料取得", description = "指定した銘柄のプレミアム料を取得するAPI", tags={ "info" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "OK", content = @Content(mediaType = "application/json", schema = @Schema(implementation = MarginPremiumResponse.class))),
